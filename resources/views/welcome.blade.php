    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                         <div class="col-md-2 float-left">
                            <div class="logo">
								<a href="index.html"><img alt="Logo" src="{{ asset('frontend/assets/img/logo.png') }} " width="56" height="50"></a>
                            </div>
                        </div>
                        <div class="col-md-10">
									...
									<ul class="nav navbar-nav main-nav float-right ml-auto">
                                        ...
                                        @if (Route::has('login'))
                                                ...
                                                <li class="nav-item">
                                                    <a
                                                        href="{{ url('/dashboard') }}"
                                                        class="btn btn-primary appoint-btn nav-link"
                                                    >
                                                        Dashboard
                                                    </a>
                                                </li>
                                                ...
                                                <li class="dropdown nav-item">
                                                    <a class="dropdown-toggle settings-icon nav-link" data-toggle="dropdown"><i class="fa fa-cog"></i></a>
                                                        ...
                                                        @endif
                                                        <a class="dropdown-item" href="{{ url('forgot-password') }}">Forgot Password</a>
                                                        </div>
                                                </li>
                                                @endauth
                                        @endif
        ...
        <header class="mobile-header">
            ...
            <div class="page_title">
				<a href="index.html"><img src="{{ asset('frontend/assets/img/logo.png') }}" alt="Logo" class="img-fluid" width="60" height="60"></a>
            </div>
        </header>
		<!-- Mobile Header /-->
                ...
                <div class="container">
                    ...
                    <div class="row feature-row">
                        <div class="col-md-4">
                            <div class="feature-box">
                                <div class="feature-img">
                                    <img width="60" height="60" alt="Book an Appointment" src="{{ asset('frontend/assets/img/icon-01.png') }}">
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="feature-box">
                                <div class="feature-img">
                                    <img width="60" height="60" alt="Consult with a Doctor" src="{{ asset('frontend/assets/img/icon-02.png') }}">
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="feature-box">
                                <div class="feature-img">
                                    <img width="60" height="60" alt="Make a family Doctor" src="{{ asset('frontend/assets/img/icon-03.png') }}">
                                </div>
                ...
                <div class="container">
                    ...
                    <div id="our_doctor" class="owl-carousel text-center">
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-01.jpg') }}" alt="Dr. Albert Sandoval" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
							<a href="doctor-details.html">
								<div class="doctor text-center">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-02.jpg') }}" alt="Dr. Linda Barrett" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-03.jpg') }}" alt="Dr. Cristina Groves" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-04.jpg') }}" alt="Dr. Henry Daniels" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-05.jpg') }}" alt="Dr. Diana Bailey" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-06.jpg') }}" alt="Dr. Justin Parker" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-07.jpg') }}" alt="Dr. Marie Wells" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-08.jpg') }}" alt="Dr. Pamela Curtis" class="rounded-circle" width="150" height="150">
                        ...
                        <div class="item">
                            <div class="doctor text-center">
								<a href="doctor-details.html">
									<img src="{{ asset('frontend/assets/img/doctor-thumb-09.jpg') }}" alt="Dr. Ronald Jacobs" class="rounded-circle" width="150" height="150">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="dept-box">
                                <div class="dept-img">
									<a href="department-details.html"><img width="67" height="80" alt="Dentists" src="{{ asset('frontend/assets/img/icon-04.png') }}"></a>
                                </div>
                                <h4>
                        ...
                        <div class="col-md-4">
                            <div class="dept-box">
                                <div class="dept-img">
									<a href="department-details.html"><img width="63" height="80" alt="Neurology" src="{{ asset('frontend/assets/img/icon-05.png') }}"></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="dept-box">
                                <div class="dept-img">
									<a href="department-details.html"><img width="92" height="80" alt="Opthalmology" src="{{ asset('frontend/assets/img/icon-06.png') }}"></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="dept-box">
                                <div class="dept-img">
									<a href="department-details.html"><img width="40" height="80" alt="Orthopedics" src="{{ asset('frontend/assets/img/icon-07.png') }}"></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="dept-box">
                                <div class="dept-img">
									<a href="department-details.html"><img width="76" height="80" alt="Cancer Department" src="{{ asset('frontend/assets/img/icon-08.png') }}"></a>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="dept-box">
                                <div class="dept-img">
									<a href="department-details.html"><img width="47" height="80" alt="ENT Department" src="{{ asset('frontend/assets/img/icon-09.png') }}"></a>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div id="testimonial_slider" class="owl-carousel text-center">
                                <div class="item">
                                    <div class="testimonial-list">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset('frontend/assets/img/testi-03.jpg') }}" alt="" width="150" height="150">
                                        </div>
                                ...
                                <div class="item">
                                    <div class="testimonial-list">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset('frontend/assets/img/testi-02.jpg') }}" alt="" width="150" height="150">
                                        </div>
                                        <div class="testimonial-text">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                                tempor incididunt ut labore et dolore.
                                ...
                                <div class="item">
                                    <div class="testimonial-list">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset('frontend/assets/img/testi-05.jpg') }}" alt="" width="150" height="150">
                                        </div>
                                        <div class="testimonial-text">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                                tempor incididunt ut labore et dolore.
                                ...
                                <div class="item">
                                    <div class="testimonial-list">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset('frontend/assets/img/testi-04.jpg') }}" alt="" width="150" height="150">
                                        </div>
                                        <div class="testimonial-text">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                                tempor incididunt ut labore et dolore.
                                ...
                                <div class="item">
                                    <div class="testimonial-list">
                                        <div class="testimonial-img">
                                            <img class="img-fluid" src="{{ asset('frontend/assets/img/testi-01.jpg') }}" alt="" width="150" height="150">
                                        </div>
                                        <div class="testimonial-text">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                                tempor incididunt ut labore et dolore.
